...
def snake_game():
    ...
    if game_over:
        ...
        game_screen.blit(text_go,
                         (screen_width / 2 - text_go.get_width() / 2, screen_height / 2 - text_go.get_height() / 2))
        font_score = pygame.font.SysFont('Arial', 30)
        text_score = font_score.render('Final Score: ' + str(score), True, pygame.Color('red'))
        game_screen.blit(text_score, (
        screen_width / 2 - text_score.get_width() / 2, screen_height / 2 + text_score.get_height() / 2))
        pygame.mixer.init()
